...
class Match {
    ...
    distributeCards(player) {
        const hand = [];
        for (let i = 0; i < 5; i++) {                                   // например, 5 карт в руке
    ...
    timeUp() {
        ...
        if (this.attackCard !== null && this.defenseCard === null) {
            console.log(`Час на хід ${this.turnPlayer.login} сплив!\n
    ...
    endTurn() {
        ...
        this.turnPlayer = this.turnPlayer === this.player1 ? this.player2 : this.player1; // Смена игрока
